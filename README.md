...
| ---- | ----- | --------- | ------------ |
| 1.A  | 06.11.23      | Erjon Hulaj          | Anforderung 1: Erstellung der Benutzeroberfläche und ausseinandersetzung mit Forms (Design u.s.w) [Erjon] für die Eingabe von Kauf- und Verkaufsdatum, Kapital und Zinssatz (Code) [Seyon], Dokumentation [Aven]             |
