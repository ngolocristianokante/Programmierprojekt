...
| ---- | ----- | --------- | ------------ |
| 1.A  | 03.11.23      | Erjon Hulaj          | Anforderung 1: Erstellung der Benutzeroberfläche für die Eingabe von Kauf- und Verkaufsdatum, Kapital und Zinssatz, Dokumentation.             |
